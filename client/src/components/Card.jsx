...
const Card = ({ id, img, title, year, type }) => {
    ...
    return (
        <div className='relative w-[30rem] h-64 max-w-md overflow-hidden rounded-lg mt-4 transition duration-300 cursor-pointer ease-in-out hover:scale-105 hover:text-redcol'>
